      ...
      <el-row :gutter="10" class="mb8">
        <el-col :span="1.5">
          <el-button
            ...
            size="mini"
            @click="handleExport"
            v-hasPermi="['biz/monitor:eq:export']"
          >导出
          </el-button>
        </el-col>
...
<script>
import { listEq } from '@/api/biz/monitor/eq'
import {
  factoryNameList,
  workshopNameList
} from '@/api/biz/monitor/factoryAndWorkshopNameList'
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('biz/monitor/eq/export', {
        ...this.queryParams
