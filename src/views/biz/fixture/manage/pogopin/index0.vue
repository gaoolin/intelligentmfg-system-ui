<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column label="料号" align="center" min-width="100" prop="materialId" fixed />
      <el-table-column label="机种" align="center" min-width="90" prop="prodType" fixed />
      <el-table-column label="治具类别" align="center" min-width="100" prop="fixtureCategory" fixed>
  ...
  methods: {
    ...
    handleExport() {
      this.download('biz/fixture/manage/pogopin/export', {
        ...this.queryParams
      }, `fixture_${new Date().getTime()}.xlsx`)
    }
  }
};
</script>
