  ...
  methods: {
    ...
    reset() {
      this.editForm = {
        ...
        chartAlignmentYResMin: null,
        chartAlignmentYResMax: null,

        chartAlignment1XResMin: null,
        chartAlignment1XResMax: null,
        chartAlignment1YResMin: null,
        chartAlignment1YResMax: null,

        chartAlignment2XResMin: null,
        chartAlignment2XResMax: null,
        chartAlignment2YResMin: null,
        chartAlignment2YResMax: null,

        epoxyInspectionInterval: null,

        vcmCheckResultCheckMin: null,
        vcmCheckResultCheckMax: null,

        recordPositionUtXyzMove: null,

        ocCheckXOffsetMin: null,
        ocCheckXOffsetMax: null,
        ocCheckYOffsetMin: null,
        ocCheckYOffsetMax: null,

        saveOcXOffsetMin: null,
        saveOcXOffsetMax: null,
        saveOcYOffsetMin: null,
        saveOcYOffsetMax: null,
