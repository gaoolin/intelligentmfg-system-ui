    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['biz/standard:query:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['biz/standard:query:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['biz/standard:query:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['biz/standard:query:export']"
        >导出</el-button>
      </el-col>
...
<!--      <el-table-column label="主键" align="center" prop="id" />-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="机型" prop="mcId">
          <el-input v-model="form.mcId" placeholder="请输入机型" :disabled="isDisabled"/>
        </el-form-item>
        <el-form-item label="线径" prop="wireWidth">
...
<script>
import { listQuery, getQuery, delQuery, addQuery, updateQuery } from "@/api/biz/standard/query";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除金线标准用量信息编号为"' + this.mcIds + '"的数据项？').then(function() {
        return delQuery(ids);
      }).then(() => {
        this.getList();
